...
public class Rule {
	...
	public Rule(String s) {
		...
		GameRuleDomainModel gr = hs.get(s);
		HashMap<String, GameRuleCardsDomainModel> hc = new HashMap();
		hc = GameRuleCardsBLL.getRuleCardsHashSet(gr.getRULEID());
		GameRuleCardsDomainModel gc = hc.get(gr.getRULEID());
		...
		// dont know how to input data from sql to integer array
	}
